...
export const PhoenixLogo = () => {
  ...
  useEffect(() => {
    console.log('🔥 Phoenix Logo: isTripleClicked changed:', isTripleClicked);
    if (isTripleClicked) {
      console.log('🔥 Phoenix Logo: Triple-click detected! Showing covenant...');
      setShowCovenant(true);
    }
  }, [isTripleClicked]);

  const handleLogoClick = (e: React.MouseEvent) => {
    console.log('🔥 Phoenix Logo: Click detected');
    handleClick();
  };
