...
export default function EmberLoading() {
  return (
    <div className="min-h-screen bg-black text-white p-6">
      <div className="grid grid-cols-12 gap-6">
        ...
        {/* Operation Visualization Skeleton */}
        <div className="col-span-4">
          <div className="bg-zinc-900/80 border border-red-700 rounded-lg p-4">
            <div className="h-6 w-36 bg-zinc-800 rounded animate-pulse mb-4"></div>
            <div className="h-48 bg-zinc-800 rounded animate-pulse"></div>
          </div>
        </div>
