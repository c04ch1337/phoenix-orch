// This file loads before the test and sets up global mocks
import { vi } from 'vitest';

// Create a complete mock of WebSocket to avoid the 'on' method error
class MockWebSocket {
  onopen: any = null;
  onmessage: any = null;
  onclose: any = null;
  ...
  // Support both event emitter and DOM event styles
